...
| 2 | [PLAN-002](PLAN-002-native-waiter.md) | Native notification waiter for the Python consumer | M (1–2 wk) | Proposed | — |
| 3 | [PLAN-003](PLAN-003-cuda-bindings-adapter.md) | Optional `cuda.bindings` adapter (benchmark-gated) | M (1–2 wk) | Proposed | — |
| 4 | [PLAN-001](PLAN-001-cpp-custom-top.md) | C++ Custom TOP sender/receiver inside TouchDesigner | L (4–6 wk) | Proposed | soft: PLAN-002 |
