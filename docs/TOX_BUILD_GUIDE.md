...
Step-by-step instructions for building the `CUDAIPCLink_v1.2.0.tox` component in TouchDesigner.
...
3. Save to: `TOXES\CUDAIPCLink_v1.2.0.tox` inside the project root

**Naming convention**: Use `CUDAIPCLink_v1.2.0.tox` (matches version) for clarity. The `TOXES\` subfolder keeps versioned binaries separate from source files.
...
1. Drag `CUDAIPCLink_v1.2.0.tox` from Windows Explorer into your TD network
...
| `CUDAIPCLink_v1.2.0.tox` | `TOXES/` | Final built .tox component |
